...
from aplicatie.models import Instrument, Categorie, Brand, Promotie, CustomUser
import re
...
class ContactForm(forms.Form):
    ...
    tip_mesaj = forms.ChoiceField(choices=[('reclamatie', 'Reclamație'), ('intrebare', 'Întrebare'), ('review', 'Review'), ('cerere', 'Cerere'), ('programare', 'Programare')])
...
class InstrumentForm(forms.ModelForm):
    ...
    class Meta:
        model = Instrument
        fields = ['nume', 'pret', 'brand', 'categorie']  
        labels = {
...
class PromotieForm(forms.ModelForm):
    ...
    class Meta:
        model = Promotie
        fields = ['nume', 'data_expirare', 'subiect', 'mesaj', 'categorii', 'discount', 'cod_promotie']